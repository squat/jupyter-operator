...
type NotebookInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.Notebook, error)
	List(opts meta_v1.ListOptions) (*v1.NotebookList, error)
...
func (c *notebooks) Get(name string, options meta_v1.GetOptions) (result *v1.Notebook, err error) {
	result = &v1.Notebook{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("notebooks").
...
func (c *notebooks) List(opts meta_v1.ListOptions) (result *v1.NotebookList, err error) {
...
func (c *notebooks) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("notebooks").
...
func (c *notebooks) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *notebooks) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("notebooks").
