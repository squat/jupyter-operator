...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.Notebook":       schema_pkg_apis_jupyter_v1_Notebook(ref),
		"github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.NotebookSpec":   schema_pkg_apis_jupyter_v1_NotebookSpec(ref),
		"github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.NotebookStatus": schema_pkg_apis_jupyter_v1_NotebookStatus(ref),
...
func schema_pkg_apis_jupyter_v1_Notebook(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Notebook is a Jupyter notebook instance that is run as a pod.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Description: "Specification of the desired behavior of the Jupyter Notebook. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/api-conventions.md#spec-and-status",
							Ref:         ref("github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.NotebookSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Most recent observed status of the Jupyter Notebook. Read-only. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/api-conventions.md#spec-and-status",
							Ref:         ref("github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.NotebookStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.NotebookSpec", "github.com/squat/jupyter-operator/pkg/apis/jupyter/v1.NotebookStatus"},
	}
}

func schema_pkg_apis_jupyter_v1_NotebookSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"host": {
						SchemaProps: spec.SchemaProps{
							Description: "Host to set on the notebook ingress resource. If no host is provided, no ingress will be created.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_jupyter_v1_NotebookStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
